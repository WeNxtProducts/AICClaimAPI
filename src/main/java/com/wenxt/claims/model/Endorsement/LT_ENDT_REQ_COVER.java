...
@Entity
@Table(name = "LT_ENDT_REQ_COVER")
public class LT_ENDT_REQ_COVER {

    @Id
    @SequenceGenerator(name = "EndorsementCoverSeq", sequenceName = "PEC_ENDT_TRAN_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "EndorsementCoverSeq")
    @Column(name = "PEC_TRAN_ID")
    private Integer PEC_TRAN_ID;
    ...
    private BigDecimal PEC_FC_SA;

    @Column(name = "PEC_LC_SA")
    private BigDecimal PEC_LC_SA;

    @Column(name = "PEC_RATE")
    private BigDecimal PEC_RATE;

    @Column(name = "PEC_RATE_PER")
    private Integer PEC_RATE_PER;

    @Column(name = "PEC_FC_PREM")
    private BigDecimal PEC_FC_PREM;

    @Column(name = "PEC_LC_PREM")
    private BigDecimal PEC_LC_PREM;

    @Column(name = "PEC_ORG_FC_SA")
    private BigDecimal PEC_ORG_FC_SA;

    @Column(name = "PEC_ORG_LC_SA")
    private BigDecimal PEC_ORG_LC_SA;

    @Column(name = "PEC_ORG_FC_PREM")
    private BigDecimal PEC_ORG_FC_PREM;

    @Column(name = "PEC_ORG_LC_PREM")
    private BigDecimal PEC_ORG_LC_PREM;
    ...
    private BigDecimal PEC_FC_CL_PREM;

    @Column(name = "PEC_LC_CL_PREM")
    private BigDecimal PEC_LC_CL_PREM;

    @Column(name = "PEC_FC_TTY_PREM")
    private BigDecimal PEC_FC_TTY_PREM;

    @Column(name = "PEC_LC_TTY_PREM")
    private BigDecimal PEC_LC_TTY_PREM;

    @Column(name = "PEC_ORG_FC_CL_PREM")
    private BigDecimal PEC_ORG_FC_CL_PREM;

    @Column(name = "PEC_ORG_LC_CL_PREM")
    private BigDecimal PEC_ORG_LC_CL_PREM;

    @Column(name = "PEC_ORG_FC_TTY_PREM")
    private BigDecimal PEC_ORG_FC_TTY_PREM;

    @Column(name = "PEC_ORG_LC_TTY_PREM")
    private BigDecimal PEC_ORG_LC_TTY_PREM;

    @Column(name = "PEC_REC_TYPE")
    private String PEC_REC_TYPE;

    @Column(name = "PEC_FC_RET_PREM")
    private BigDecimal PEC_FC_RET_PREM;

    @Column(name = "PEC_LC_RET_PREM")
    private BigDecimal PEC_LC_RET_PREM;

    @Column(name = "PEC_FC_RI_PREM")
    private BigDecimal PEC_FC_RI_PREM;

    @Column(name = "PEC_LC_RI_PREM")
    private BigDecimal PEC_LC_RI_PREM;

    @Column(name = "PEC_LC_ACTUAL_SA")
    private BigDecimal PEC_LC_ACTUAL_SA;

    @Column(name = "PEC_FC_ACTUAL_SA")
    private BigDecimal PEC_FC_ACTUAL_SA;

    @Column(name = "PEC_ORG_FC_RET_PREM")
    private BigDecimal PEC_ORG_FC_RET_PREM;

    @Column(name = "PEC_ORG_LC_RET_PREM")
    private BigDecimal PEC_ORG_LC_RET_PREM;

    @Column(name = "PEC_ORG_FC_RI_PREM")
    private BigDecimal PEC_ORG_FC_RI_PREM;

    @Column(name = "PEC_ORG_LC_RI_PREM")
    private BigDecimal PEC_ORG_LC_RI_PREM;

    @Column(name = "PEC_ORG_LC_ACTUAL_SA")
    private BigDecimal PEC_ORG_LC_ACTUAL_SA;

    @Column(name = "PEC_ORG_FC_ACTUAL_SA")
    private BigDecimal PEC_ORG_FC_ACTUAL_SA;
    ...
    private Integer PEC_CVR_LINK_TRAN_ID;
    ...
    private Integer PEC_REF_PEMP_TRAN_ID;

    @Column(name = "PEC_LC_COVER_FCL")
    private BigDecimal PEC_LC_COVER_FCL;

    @Column(name = "PEC_FC_COVER_FCL")
    private BigDecimal PEC_FC_COVER_FCL;
	...
	public Integer getPEC_TRAN_ID() {
		return PEC_TRAN_ID;
	}

	public void setPEC_TRAN_ID(Integer pEC_TRAN_ID) {
	...
	public BigDecimal getPEC_FC_SA() {
		return PEC_FC_SA;
	}

	public void setPEC_FC_SA(BigDecimal pEC_FC_SA) {
		PEC_FC_SA = pEC_FC_SA;
	}

	public BigDecimal getPEC_LC_SA() {
		return PEC_LC_SA;
	}

	public void setPEC_LC_SA(BigDecimal pEC_LC_SA) {
		PEC_LC_SA = pEC_LC_SA;
	}

	public BigDecimal getPEC_RATE() {
		return PEC_RATE;
	}

	public void setPEC_RATE(BigDecimal pEC_RATE) {
		PEC_RATE = pEC_RATE;
	}

	public Integer getPEC_RATE_PER() {
		return PEC_RATE_PER;
	}

	public void setPEC_RATE_PER(Integer pEC_RATE_PER) {
		PEC_RATE_PER = pEC_RATE_PER;
	}

	public BigDecimal getPEC_FC_PREM() {
		return PEC_FC_PREM;
	}

	public void setPEC_FC_PREM(BigDecimal pEC_FC_PREM) {
		PEC_FC_PREM = pEC_FC_PREM;
	}

	public BigDecimal getPEC_LC_PREM() {
		return PEC_LC_PREM;
	}

	public void setPEC_LC_PREM(BigDecimal pEC_LC_PREM) {
		PEC_LC_PREM = pEC_LC_PREM;
	}

	public BigDecimal getPEC_ORG_FC_SA() {
		return PEC_ORG_FC_SA;
	}

	public void setPEC_ORG_FC_SA(BigDecimal pEC_ORG_FC_SA) {
		PEC_ORG_FC_SA = pEC_ORG_FC_SA;
	}

	public BigDecimal getPEC_ORG_LC_SA() {
		return PEC_ORG_LC_SA;
	}

	public void setPEC_ORG_LC_SA(BigDecimal pEC_ORG_LC_SA) {
		PEC_ORG_LC_SA = pEC_ORG_LC_SA;
	}

	public BigDecimal getPEC_ORG_FC_PREM() {
		return PEC_ORG_FC_PREM;
	}

	public void setPEC_ORG_FC_PREM(BigDecimal pEC_ORG_FC_PREM) {
		PEC_ORG_FC_PREM = pEC_ORG_FC_PREM;
	}

	public BigDecimal getPEC_ORG_LC_PREM() {
		return PEC_ORG_LC_PREM;
	}

	public void setPEC_ORG_LC_PREM(BigDecimal pEC_ORG_LC_PREM) {
	...
	public BigDecimal getPEC_FC_CL_PREM() {
		return PEC_FC_CL_PREM;
	}

	public void setPEC_FC_CL_PREM(BigDecimal pEC_FC_CL_PREM) {
		PEC_FC_CL_PREM = pEC_FC_CL_PREM;
	}

	public BigDecimal getPEC_LC_CL_PREM() {
		return PEC_LC_CL_PREM;
	}

	public void setPEC_LC_CL_PREM(BigDecimal pEC_LC_CL_PREM) {
		PEC_LC_CL_PREM = pEC_LC_CL_PREM;
	}

	public BigDecimal getPEC_FC_TTY_PREM() {
		return PEC_FC_TTY_PREM;
	}

	public void setPEC_FC_TTY_PREM(BigDecimal pEC_FC_TTY_PREM) {
		PEC_FC_TTY_PREM = pEC_FC_TTY_PREM;
	}

	public BigDecimal getPEC_LC_TTY_PREM() {
		return PEC_LC_TTY_PREM;
	}

	public void setPEC_LC_TTY_PREM(BigDecimal pEC_LC_TTY_PREM) {
		PEC_LC_TTY_PREM = pEC_LC_TTY_PREM;
	}

	public BigDecimal getPEC_ORG_FC_CL_PREM() {
		return PEC_ORG_FC_CL_PREM;
	}

	public void setPEC_ORG_FC_CL_PREM(BigDecimal pEC_ORG_FC_CL_PREM) {
		PEC_ORG_FC_CL_PREM = pEC_ORG_FC_CL_PREM;
	}

	public BigDecimal getPEC_ORG_LC_CL_PREM() {
		return PEC_ORG_LC_CL_PREM;
	}

	public void setPEC_ORG_LC_CL_PREM(BigDecimal pEC_ORG_LC_CL_PREM) {
		PEC_ORG_LC_CL_PREM = pEC_ORG_LC_CL_PREM;
	}

	public BigDecimal getPEC_ORG_FC_TTY_PREM() {
		return PEC_ORG_FC_TTY_PREM;
	}

	public void setPEC_ORG_FC_TTY_PREM(BigDecimal pEC_ORG_FC_TTY_PREM) {
		PEC_ORG_FC_TTY_PREM = pEC_ORG_FC_TTY_PREM;
	}

	public BigDecimal getPEC_ORG_LC_TTY_PREM() {
		return PEC_ORG_LC_TTY_PREM;
	}

	public void setPEC_ORG_LC_TTY_PREM(BigDecimal pEC_ORG_LC_TTY_PREM) {
	...
	public BigDecimal getPEC_FC_RET_PREM() {
		return PEC_FC_RET_PREM;
	}

	public void setPEC_FC_RET_PREM(BigDecimal pEC_FC_RET_PREM) {
		PEC_FC_RET_PREM = pEC_FC_RET_PREM;
	}

	public BigDecimal getPEC_LC_RET_PREM() {
		return PEC_LC_RET_PREM;
	}

	public void setPEC_LC_RET_PREM(BigDecimal pEC_LC_RET_PREM) {
		PEC_LC_RET_PREM = pEC_LC_RET_PREM;
	}

	public BigDecimal getPEC_FC_RI_PREM() {
		return PEC_FC_RI_PREM;
	}

	public void setPEC_FC_RI_PREM(BigDecimal pEC_FC_RI_PREM) {
		PEC_FC_RI_PREM = pEC_FC_RI_PREM;
	}

	public BigDecimal getPEC_LC_RI_PREM() {
		return PEC_LC_RI_PREM;
	}

	public void setPEC_LC_RI_PREM(BigDecimal pEC_LC_RI_PREM) {
		PEC_LC_RI_PREM = pEC_LC_RI_PREM;
	}

	public BigDecimal getPEC_LC_ACTUAL_SA() {
		return PEC_LC_ACTUAL_SA;
	}

	public void setPEC_LC_ACTUAL_SA(BigDecimal pEC_LC_ACTUAL_SA) {
		PEC_LC_ACTUAL_SA = pEC_LC_ACTUAL_SA;
	}

	public BigDecimal getPEC_FC_ACTUAL_SA() {
		return PEC_FC_ACTUAL_SA;
	}

	public void setPEC_FC_ACTUAL_SA(BigDecimal pEC_FC_ACTUAL_SA) {
		PEC_FC_ACTUAL_SA = pEC_FC_ACTUAL_SA;
	}

	public BigDecimal getPEC_ORG_FC_RET_PREM() {
		return PEC_ORG_FC_RET_PREM;
	}

	public void setPEC_ORG_FC_RET_PREM(BigDecimal pEC_ORG_FC_RET_PREM) {
		PEC_ORG_FC_RET_PREM = pEC_ORG_FC_RET_PREM;
	}

	public BigDecimal getPEC_ORG_LC_RET_PREM() {
		return PEC_ORG_LC_RET_PREM;
	}

	public void setPEC_ORG_LC_RET_PREM(BigDecimal pEC_ORG_LC_RET_PREM) {
		PEC_ORG_LC_RET_PREM = pEC_ORG_LC_RET_PREM;
	}

	public BigDecimal getPEC_ORG_FC_RI_PREM() {
		return PEC_ORG_FC_RI_PREM;
	}

	public void setPEC_ORG_FC_RI_PREM(BigDecimal pEC_ORG_FC_RI_PREM) {
		PEC_ORG_FC_RI_PREM = pEC_ORG_FC_RI_PREM;
	}

	public BigDecimal getPEC_ORG_LC_RI_PREM() {
		return PEC_ORG_LC_RI_PREM;
	}

	public void setPEC_ORG_LC_RI_PREM(BigDecimal pEC_ORG_LC_RI_PREM) {
		PEC_ORG_LC_RI_PREM = pEC_ORG_LC_RI_PREM;
	}

	public BigDecimal getPEC_ORG_LC_ACTUAL_SA() {
		return PEC_ORG_LC_ACTUAL_SA;
	}

	public void setPEC_ORG_LC_ACTUAL_SA(BigDecimal pEC_ORG_LC_ACTUAL_SA) {
		PEC_ORG_LC_ACTUAL_SA = pEC_ORG_LC_ACTUAL_SA;
	}

	public BigDecimal getPEC_ORG_FC_ACTUAL_SA() {
		return PEC_ORG_FC_ACTUAL_SA;
	}

	public void setPEC_ORG_FC_ACTUAL_SA(BigDecimal pEC_ORG_FC_ACTUAL_SA) {
	...
	public Integer getPEC_CVR_LINK_TRAN_ID() {
		return PEC_CVR_LINK_TRAN_ID;
	}

	public void setPEC_CVR_LINK_TRAN_ID(Integer pEC_CVR_LINK_TRAN_ID) {
	...
	public Integer getPEC_REF_PEMP_TRAN_ID() {
		return PEC_REF_PEMP_TRAN_ID;
	}

	public void setPEC_REF_PEMP_TRAN_ID(Integer pEC_REF_PEMP_TRAN_ID) {
		PEC_REF_PEMP_TRAN_ID = pEC_REF_PEMP_TRAN_ID;
	}

	public BigDecimal getPEC_LC_COVER_FCL() {
		return PEC_LC_COVER_FCL;
	}

	public void setPEC_LC_COVER_FCL(BigDecimal pEC_LC_COVER_FCL) {
		PEC_LC_COVER_FCL = pEC_LC_COVER_FCL;
	}

	public BigDecimal getPEC_FC_COVER_FCL() {
		return PEC_FC_COVER_FCL;
	}

	public void setPEC_FC_COVER_FCL(BigDecimal pEC_FC_COVER_FCL) {
