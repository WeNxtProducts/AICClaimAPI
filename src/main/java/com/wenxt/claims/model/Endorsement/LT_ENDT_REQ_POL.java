...
@Entity
@Table(name = "LT_ENDT_REQ_POL", schema = "LIFE_DEV")
public class LT_ENDT_REQ_POL {

    @Id
    @SequenceGenerator(name = "EndorsementPolicySeq", sequenceName = "POL_ENDT_TRAN_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "EndorsementPolicySeq")
    ...
    private Long POL_ORG_NO_OF_EMP;
    ...
    private BigDecimal POL_DISC_RATE;

    @Column(name = "POL_TOT_NET_RATE")
    private BigDecimal POL_TOT_NET_RATE;
    ...
    private Long POL_CLM_INTM_DAYS;
    ...
    private BigDecimal POL_FC_BROK_ADMIN_CHARGE;

    @Column(name = "POL_LC_BROK_ADMIN_CHARGE")
    private BigDecimal POL_LC_BROK_ADMIN_CHARGE;

    @Column(name = "POL_BROK_ADMIN_CHG_PERC")
    private BigDecimal POL_BROK_ADMIN_CHG_PERC;

    @Column(name = "POL_CREDIT_DICOUNT_PERC")
    private BigDecimal POL_CREDIT_DICOUNT_PERC;

    @Column(name = "POL_GROSS_FC_PREM")
    private BigDecimal POL_GROSS_FC_PREM;

    @Column(name = "POL_GROSS_LC_PREM")
    private BigDecimal POL_GROSS_LC_PREM;
    ...
    private BigDecimal POL_FC_DEPOSIT_PREM;

    @Column(name = "POL_LC_DEPOSIT_PREM")
    private BigDecimal POL_LC_DEPOSIT_PREM;
    ...
    private BigDecimal POL_LC_TAKE_OVER_FCL;
    ...
    private BigDecimal POL_ORG_LC_TAKE_OVER_FCL;
    ...
    private Long POL_MIN_NO_OF_MEMBER;
    ...
    private BigDecimal POL_AUTH_LIMIT;
    ...
    private Long POL_DEFER_PRD;

    @Column(name = "POL_CO_COMM_PER")
    private BigDecimal POL_CO_COMM_PER;

    @Column(name = "POL_CO_MED_FEE")
    private BigDecimal POL_CO_MED_FEE;

    @Column(name = "POL_CO_SA_LC")
    private BigDecimal POL_CO_SA_LC;

    @Column(name = "POL_CO_TOT_PRM")
    private BigDecimal POL_CO_TOT_PRM;
    ...
    private Long POL_JOINT_LIFE_AGE;
	...
	public Long getPOL_NO_OF_EMP() {
		return POL_NO_OF_EMP;
	}

	public void setPOL_NO_OF_EMP(Long pOL_NO_OF_EMP) {
	...
	public Long getPOL_ORG_NO_OF_EMP() {
		return POL_ORG_NO_OF_EMP;
	}

	public void setPOL_ORG_NO_OF_EMP(Long pOL_ORG_NO_OF_EMP) {
	...
	public BigDecimal getPOL_DISC_RATE() {
		return POL_DISC_RATE;
	}

	public void setPOL_DISC_RATE(BigDecimal pOL_DISC_RATE) {
		POL_DISC_RATE = pOL_DISC_RATE;
	}

	public BigDecimal getPOL_TOT_NET_RATE() {
		return POL_TOT_NET_RATE;
	}

	public void setPOL_TOT_NET_RATE(BigDecimal pOL_TOT_NET_RATE) {
	...
	public Long getPOL_CLM_INTM_DAYS() {
		return POL_CLM_INTM_DAYS;
	}

	public void setPOL_CLM_INTM_DAYS(Long pOL_CLM_INTM_DAYS) {
	...
	public BigDecimal getPOL_FC_BROK_ADMIN_CHARGE() {
		return POL_FC_BROK_ADMIN_CHARGE;
	}

	public void setPOL_FC_BROK_ADMIN_CHARGE(BigDecimal pOL_FC_BROK_ADMIN_CHARGE) {
		POL_FC_BROK_ADMIN_CHARGE = pOL_FC_BROK_ADMIN_CHARGE;
	}

	public BigDecimal getPOL_LC_BROK_ADMIN_CHARGE() {
		return POL_LC_BROK_ADMIN_CHARGE;
	}

	public void setPOL_LC_BROK_ADMIN_CHARGE(BigDecimal pOL_LC_BROK_ADMIN_CHARGE) {
		POL_LC_BROK_ADMIN_CHARGE = pOL_LC_BROK_ADMIN_CHARGE;
	}

	public BigDecimal getPOL_BROK_ADMIN_CHG_PERC() {
		return POL_BROK_ADMIN_CHG_PERC;
	}

	public void setPOL_BROK_ADMIN_CHG_PERC(BigDecimal pOL_BROK_ADMIN_CHG_PERC) {
		POL_BROK_ADMIN_CHG_PERC = pOL_BROK_ADMIN_CHG_PERC;
	}

	public BigDecimal getPOL_CREDIT_DICOUNT_PERC() {
		return POL_CREDIT_DICOUNT_PERC;
	}

	public void setPOL_CREDIT_DICOUNT_PERC(BigDecimal pOL_CREDIT_DICOUNT_PERC) {
		POL_CREDIT_DICOUNT_PERC = pOL_CREDIT_DICOUNT_PERC;
	}

	public BigDecimal getPOL_GROSS_FC_PREM() {
		return POL_GROSS_FC_PREM;
	}

	public void setPOL_GROSS_FC_PREM(BigDecimal pOL_GROSS_FC_PREM) {
		POL_GROSS_FC_PREM = pOL_GROSS_FC_PREM;
	}

	public BigDecimal getPOL_GROSS_LC_PREM() {
		return POL_GROSS_LC_PREM;
	}

	public void setPOL_GROSS_LC_PREM(BigDecimal pOL_GROSS_LC_PREM) {
	...
	public BigDecimal getPOL_WO_CLM_NET_RATE() {
		return POL_WO_CLM_NET_RATE;
	}

	public void setPOL_WO_CLM_NET_RATE(BigDecimal pOL_WO_CLM_NET_RATE) {
	...
	public Long getPOL_FAC_BASIS() {
		return POL_FAC_BASIS;
	}

	public void setPOL_FAC_BASIS(Long pOL_FAC_BASIS) {
	...
	public BigDecimal getPOL_FC_ANN_SAL() {
		return POL_FC_ANN_SAL;
	}

	public void setPOL_FC_ANN_SAL(BigDecimal pOL_FC_ANN_SAL) {
		POL_FC_ANN_SAL = pOL_FC_ANN_SAL;
	}

	public BigDecimal getPOL_LC_ANN_SAL() {
		return POL_LC_ANN_SAL;
	}

	public void setPOL_LC_ANN_SAL(BigDecimal pOL_LC_ANN_SAL) {
	...
	public BigDecimal getPOL_FC_DEPOSIT_PREM() {
		return POL_FC_DEPOSIT_PREM;
	}

	public void setPOL_FC_DEPOSIT_PREM(BigDecimal pOL_FC_DEPOSIT_PREM) {
		POL_FC_DEPOSIT_PREM = pOL_FC_DEPOSIT_PREM;
	}

	public BigDecimal getPOL_LC_DEPOSIT_PREM() {
		return POL_LC_DEPOSIT_PREM;
	}

	public void setPOL_LC_DEPOSIT_PREM(BigDecimal pOL_LC_DEPOSIT_PREM) {
	...
	public BigDecimal getPOL_LC_TAKE_OVER_FCL() {
		return POL_LC_TAKE_OVER_FCL;
	}

	public void setPOL_LC_TAKE_OVER_FCL(BigDecimal pOL_LC_TAKE_OVER_FCL) {
	...
	public BigDecimal getPOL_ORG_LC_TAKE_OVER_FCL() {
		return POL_ORG_LC_TAKE_OVER_FCL;
	}

	public void setPOL_ORG_LC_TAKE_OVER_FCL(BigDecimal pOL_ORG_LC_TAKE_OVER_FCL) {
	...
	public Long getPOL_NO_OF_INST() {
		return POL_NO_OF_INST;
	}

	public void setPOL_NO_OF_INST(Long pOL_NO_OF_INST) {
	...
	public Long getPOL_REN_COUNT() {
		return POL_REN_COUNT;
	}

	public void setPOL_REN_COUNT(Long pOL_REN_COUNT) {
	...
	public BigDecimal getPOL_ORG_FC_FIRST_PREM() {
		return POL_ORG_FC_FIRST_PREM;
	}

	public void setPOL_ORG_FC_FIRST_PREM(BigDecimal pOL_ORG_FC_FIRST_PREM) {
		POL_ORG_FC_FIRST_PREM = pOL_ORG_FC_FIRST_PREM;
	}

	public BigDecimal getPOL_ORG_LC_FIRST_PREM() {
		return POL_ORG_LC_FIRST_PREM;
	}

	public void setPOL_ORG_LC_FIRST_PREM(BigDecimal pOL_ORG_LC_FIRST_PREM) {
	...
	public Long getPOL_DEFERMENT_PERIOD() {
		return POL_DEFERMENT_PERIOD;
	}

	public void setPOL_DEFERMENT_PERIOD(Long pOL_DEFERMENT_PERIOD) {
		POL_DEFERMENT_PERIOD = pOL_DEFERMENT_PERIOD;
	}

	public Long getPOL_NO_OF_MEMBER() {
		return POL_NO_OF_MEMBER;
	}

	public void setPOL_NO_OF_MEMBER(Long pOL_NO_OF_MEMBER) {
		POL_NO_OF_MEMBER = pOL_NO_OF_MEMBER;
	}

	public Long getPOL_ORG_NO_OF_MEMBER() {
		return POL_ORG_NO_OF_MEMBER;
	}

	public void setPOL_ORG_NO_OF_MEMBER(Long pOL_ORG_NO_OF_MEMBER) {
	...
	public BigDecimal getPOL_FLEX_01() {
		return POL_FLEX_01;
	}

	public void setPOL_FLEX_01(BigDecimal pOL_FLEX_01) {
		POL_FLEX_01 = pOL_FLEX_01;
	}

	public Long getPOL_ADV_CONT_COUNT() {
		return POL_ADV_CONT_COUNT;
	}

	public void setPOL_ADV_CONT_COUNT(Long pOL_ADV_CONT_COUNT) {
	...
	public Long getPOL_MIN_NO_OF_MEMBER() {
		return POL_MIN_NO_OF_MEMBER;
	}

	public void setPOL_MIN_NO_OF_MEMBER(Long pOL_MIN_NO_OF_MEMBER) {
	...
	public BigDecimal getPOL_AUTH_LIMIT() {
		return POL_AUTH_LIMIT;
	}

	public void setPOL_AUTH_LIMIT(BigDecimal pOL_AUTH_LIMIT) {
	...
	public Long getPOL_DEFER_PRD() {
		return POL_DEFER_PRD;
	}

	public void setPOL_DEFER_PRD(Long pOL_DEFER_PRD) {
		POL_DEFER_PRD = pOL_DEFER_PRD;
	}

	public BigDecimal getPOL_CO_COMM_PER() {
		return POL_CO_COMM_PER;
	}

	public void setPOL_CO_COMM_PER(BigDecimal pOL_CO_COMM_PER) {
		POL_CO_COMM_PER = pOL_CO_COMM_PER;
	}

	public BigDecimal getPOL_CO_MED_FEE() {
		return POL_CO_MED_FEE;
	}

	public void setPOL_CO_MED_FEE(BigDecimal pOL_CO_MED_FEE) {
		POL_CO_MED_FEE = pOL_CO_MED_FEE;
	}

	public BigDecimal getPOL_CO_SA_LC() {
		return POL_CO_SA_LC;
	}

	public void setPOL_CO_SA_LC(BigDecimal pOL_CO_SA_LC) {
		POL_CO_SA_LC = pOL_CO_SA_LC;
	}

	public BigDecimal getPOL_CO_TOT_PRM() {
		return POL_CO_TOT_PRM;
	}

	public void setPOL_CO_TOT_PRM(BigDecimal pOL_CO_TOT_PRM) {
	...
	public Long getPOL_MAT_AGE() {
		return POL_MAT_AGE;
	}

	public void setPOL_MAT_AGE(Long pOL_MAT_AGE) {
	...
	public BigDecimal getPOL_SA_LIMIT() {
		return POL_SA_LIMIT;
	}

	public void setPOL_SA_LIMIT(BigDecimal pOL_SA_LIMIT) {
	...
	public BigDecimal getPOL_ADMIN_RATE() {
		return POL_ADMIN_RATE;
	}

	public void setPOL_ADMIN_RATE(BigDecimal pOL_ADMIN_RATE) {
		POL_ADMIN_RATE = pOL_ADMIN_RATE;
	}

	public BigDecimal getPOL_ADMIN_AMT() {
		return POL_ADMIN_AMT;
	}

	public void setPOL_ADMIN_AMT(BigDecimal pOL_ADMIN_AMT) {
		POL_ADMIN_AMT = pOL_ADMIN_AMT;
	}

	public Long getPOL_REFUND_MONTHS() {
		return POL_REFUND_MONTHS;
	}

	public void setPOL_REFUND_MONTHS(Long pOL_REFUND_MONTHS) {
	...
	public Long getPOL_JOINT_LIFE_AGE() {
		return POL_JOINT_LIFE_AGE;
	}

	public void setPOL_JOINT_LIFE_AGE(Long pOL_JOINT_LIFE_AGE) {
	...
	public Long getPOL_PREM_PAY_YRS() {
		return POL_PREM_PAY_YRS;
	}

	public void setPOL_PREM_PAY_YRS(Long pOL_PREM_PAY_YRS) {
	...
	public Long getPOL_PROGRS_UPD() {
		return POL_PROGRS_UPD;
	}

	public void setPOL_PROGRS_UPD(Long pOL_PROGRS_UPD) {
	...
	public String getPOL_PREM_CALC_YN() {
		return POL_PREM_CALC_YN;
	}
