...
public class SecurityConfig { 
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception { 
		return http.csrf().disable() 
				...
				.and()
				.authorizeHttpRequests().requestMatchers("/quickQuote/**").authenticated()
				.and()
				.authorizeHttpRequests().requestMatchers("/qqApplCharge/**").authenticated()
				.and()
				.authorizeHttpRequests().requestMatchers("/qqBrokerHeader/**").authenticated()
				.and()
				.authorizeHttpRequests().requestMatchers("/qqBrokerDetail/**").authenticated()
				.and()
				.authorizeHttpRequests().requestMatchers("/planDetailMaster/**").authenticated()
				.and()
				.sessionManagement() 
